public class EncomendaEstadoRecebido implements EncomendaEstado {
    private EncomendaEstadoRecebido() {};
    private static EncomendaEstadoRecebido instance = new EncomendaEstadoRecebido();

    public static EncomendaEstadoRecebido getInstance() {
        return instance;
    }
    @Override
